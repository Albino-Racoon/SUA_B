...
# -*- coding: utf-8 -*-
"""
Končna skripta za popolno čiščenje komentarjev v CSV datoteki.
...
def clean_comments(input_file, output_file=None):
    """
    Popolno očisti komentarje v CSV datoteki z odstranitvijo vsega nepotrebnega besedila.
                ...
                for row_num, row in enumerate(reader, start=2):  # start=2 ker je prva vrstica glava
                    ...
                    try:
                        ...
                        if 'komentar' in row and row['komentar']:
                            ...
                            # Odstrani imena profesorjev na začetku komentarjev
                            comment = re.sub(r'^[A-ZČŠŽ][a-zčšž]+\s+[A-ZČŠŽ][a-zčšž]+', '', comment)
                            comment = re.sub(r'^[A-ZČŠŽ][a-zčšž]+', '', comment)
                            
                            # Odstrani ocene in številke
...
def main():
    ...
    print("Popolno čiščenje komentarjev v CSV datoteki...")
